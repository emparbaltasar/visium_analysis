...
dir.create("./output/images/mouse_brain_integration/spotlight_with_raw_data")
ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_topic_profiles.png")
...
ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_topic_profiles_facet.png", height = 9.5, width = 11.5)
...
ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_correlation_matrix.png")


plotInteractions(mat, "heatmap")
ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_interactions_heatmap.png")
...
ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_prediction_spatial_scatterpie.png")
ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_prediction_spatial_scatterpie.pdf")

# Plot spatial scatterpie with 0.1 threshold (1/10)
mat_filtered <- mat
mat_filtered[mat_filtered < 0.1] <- 0
...
ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_prediction_filtered_spatial_scatterpie.png")
ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_prediction_filtered_spatial_scatterpie.pdf")
...
for (i in rownames(visium_subset@assays$predictions@data)) {
  ...
  ggsave(paste("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_prediction_", i, ".png", sep = ""))
}
...
proportions_comparison %>%
  ...
  stat_cor(method = "pearson", label.x = 0.07, label.y = 0.15, size = 3) +
  stat_cor(method = "spearman", label.x = 0.07, label.y = 0.14, cor.coef.name = "rho", size = 3)

ggsave("./output/images/mouse_brain_integration/spotlight_with_raw_data/spotlight_lognorm_comparison_celltype_proportions_scatter.png", width = 5, height = 4)
