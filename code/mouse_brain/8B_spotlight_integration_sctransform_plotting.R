...
# Load datasets
res <- readRDS("./output/processed_data/mouse_brain/spotlight_sctransform.rds")
...
ggsave("./output/images/mouse_brain_integration/spotlight_sctransform_topic_profiles.png")
...
ggsave("./output/images/mouse_brain_integration/spotlight_sctransform_topic_profiles_facet.png", height = 9.5, width = 11.5)
...
ggsave("./output/images/mouse_brain_integration/spotlight_sctransform_correlation_matrix.png")

plotInteractions(mat, "heatmap")
ggsave("./output/images/mouse_brain_integration/spotlight_sctransform_interactions_heatmap.png")


plotInteractions(mat, "network")
ggsave("./output/images/mouse_brain_integration/spotlight_sctransform_interactions_network.png")
...
ggsave("./output/images/mouse_brain_integration/spotlight_sctransform_prediction_spatial_scatterpie.png")
ggsave("./output/images/mouse_brain_integration/spotlight_sctransform_prediction_spatial_scatterpie.pdf")
...
for (i in rownames(visium_subset@assays$predictions@data)) {
  ...
  ggsave(paste("./output/images/mouse_brain_integration/spotlight_sctransform_prediction_", i, ".png", sep = ""))
}
...
ggsave("./output/images/mouse_brain_integration/spotlight_sctransform_comparison_celltype_proportions_scatter.png", width = 5, height = 4)
