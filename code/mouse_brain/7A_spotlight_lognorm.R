...
mgs <- read.csv("./output/processed_data/mouse_brain/scrnaseq_lognorm_markers_auc.csv", row.names = 1)
...
saveRDS(res, file = "./output/processed_data/mouse_brain/spotlight_lognorm.rds")
