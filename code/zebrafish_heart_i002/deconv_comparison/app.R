...
seurat_lognorm <- readRDS("../../../output/processed_data/SCD-VI-i002/SCD-VI-i002_lognorm_seurat_predictions.rds")
DefaultAssay(seurat_lognorm) <- "prediction.score.id"

seurat_sct <- readRDS("../../../output/processed_data/SCD-VI-i002/SCD-VI-i002_sctransform_seurat_predictions.rds")
...
spotlight <- readRDS("../../../output/processed_data/SCD-VI-i002/SCD-VI-i002_lognorm_pca_clustered.rds")
mat <- res$mat
spotlight[["predictionsspotlight"]] <- CreateAssayObject(t(mat))
DefaultAssay(spotlight) <- "predictionsspotlight"

cell2loc <- Load10X_Spatial("../../../data/SCD-VI-i001-004/spaceranger_output/SCD-VI-i002/outs",
