...
visium <- readRDS("./output/processed_data/SCD-VI-i002/SCD-VI-i002_lognorm_seurat_predictions.rds")
...
for (i in rownames(visium@assays$prediction.score.id@data)) {
  ...
  ggsave(paste("./output/images/SCD-VI-i002_integration/seurat_lognorm_prediction_", i, ".png", sep = ""))
}
...
ggsave("./output/images/SCD-VI-i002_integration/seurat_lognorm_prediction_proportion_adjusted_fibroblast_(mpeg1.1).png")

SpatialFeaturePlot(visium, features = "Fibroblast (col12a1a)", pt.size.factor = 2, crop = TRUE) +
  ggplot2::scale_fill_gradientn(colours = NewPalette, limits = c(0, 0.5), breaks = c(0.0, 0.25, 0.5))
ggsave("./output/images/SCD-VI-i002_integration/seurat_lognorm_prediction_proportion_adjusted_fibroblast_(col12a1a).png")

SpatialFeaturePlot(visium, features = "Fibroblast (cxcl12a)", pt.size.factor = 2, crop = TRUE) +
  ggplot2::scale_fill_gradientn(colours = NewPalette, limits = c(0, 0.5), breaks = c(0.0, 0.25, 0.5))
ggsave("./output/images/SCD-VI-i002_integration/seurat_lognorm_prediction_proportion_adjusted_fibroblast_(cxcl12a).png")
...
ggsave("./output/images/SCD-VI-i002_integration/seurat_lognorm_prediction_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i002_integration/seurat_lognorm_prediction_spatial_scatterpie.pdf")
...
ggsave("./output/images/SCD-VI-i002_integration/seurat_lognorm_prediction_filtered_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i002_integration/seurat_lognorm_prediction_filtered_spatial_scatterpie.pdf")
