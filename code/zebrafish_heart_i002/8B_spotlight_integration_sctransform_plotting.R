...
# Load datasets
res <- readRDS("./output/processed_data/SCD-VI-i002/spotlight_sctransform-hvg_rawdata.rds")
...
ggsave("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_topic_profiles.png")
...
ggsave("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_topic_profiles_facet.png", height = 20, width = 25)
...
ggsave("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_correlation_matrix.png")


plotInteractions(mat, "heatmap")
ggsave("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_interactions_heatmap.png")
...
ggsave("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_prediction_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_prediction_spatial_scatterpie.pdf")
...
ggsave("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_prediction_filtered_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_prediction_filtered_spatial_scatterpie.pdf")
...
for (i in rownames(visium_subset@assays$predictions@data)) {
  ...
  ggsave(paste("./output/images/SCD-VI-i002_integration/spotlight_sctransform-hvg_rawdata_prediction_", i, ".png", sep = ""))
}
