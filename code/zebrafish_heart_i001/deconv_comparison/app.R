...
seurat_lognorm <- readRDS("../../../output/processed_data/SCD-VI-i001/SCD-VI-i001_lognorm_seurat_predictions.rds")
DefaultAssay(seurat_lognorm) <- "prediction.score.id"

seurat_sct <- readRDS("../../../output/processed_data/SCD-VI-i001/SCD-VI-i001_sctransform_seurat_predictions.rds")
...
spotlight <- readRDS("../../../output/processed_data/SCD-VI-i001/SCD-VI-i001_subset_lognorm_pca_clustered.rds")
mat <- res$mat
spotlight[["predictionsspotlight"]] <- CreateAssayObject(t(mat))
DefaultAssay(spotlight) <- "predictionsspotlight"

cell2loc <- readRDS("../../../output/processed_data/SCD-VI-i001/SCD-VI-i001_subset.rds")
