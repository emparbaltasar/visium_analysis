...
visium_subset <- readRDS("./output/processed_data/SCD-VI-i001/SCD-VI-i001_sctransform_seurat_predictions.rds")
...
for (i in rownames(visium_subset@assays$prediction.score.id@data)) {
  ...
  ggsave(paste("./output/images/SCD-VI-i001_integration/seurat_sctransform_prediction_", i, ".png", sep = ""))
}
...
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_prediction_proportion_adjusted_fibroblast_(mpeg1.1).png")

SpatialFeaturePlot(visium_subset, features = "Fibroblast (col12a1a)", pt.size.factor = 2, crop = TRUE) +
  ggplot2::scale_fill_gradientn(colours = NewPalette, limits = c(0, 0.5), breaks = c(0.0, 0.25, 0.5))
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_prediction_proportion_adjusted_fibroblast_(col12a1a).png")

SpatialFeaturePlot(visium_subset, features = "Fibroblast (cxcl12a)", pt.size.factor = 2, crop = TRUE) +
  ggplot2::scale_fill_gradientn(colours = NewPalette, limits = c(0, 0.5), breaks = c(0.0, 0.25, 0.5))
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_prediction_proportion_adjusted_fibroblast_(cxcl12a).png")
...
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_prediction_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_prediction_spatial_scatterpie.pdf")
...
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_prediction_filtered_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_prediction_filtered_spatial_scatterpie.pdf")
...
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_celltype_colocalization.png")
...
ggsave("./output/images/SCD-VI-i001_integration/seurat_sctransform_shannon_index.png")
