...
# Normalization
scrnaseq <- SCTransform(scrnaseq, ncells = 3000, verbose = TRUE)

scrnaseq <- RunPCA(scrnaseq, npcs = 30, verbose = FALSE)
scrnaseq <- RunUMAP(scrnaseq, reduction = "pca", dims = 1:30, verbose = FALSE)

saveRDS(scrnaseq, "./output/processed_data/SCD-VI-i001/zebrafish_heart_scrnaseq_sctransform_pca.rds")
...
# ggsave("./output/images/SCD-VI-i001_analysis/scrnaseq_umap_celltypes.png")
# 
...
# ggsave("./output/images/SCD-VI-i001_analysis/scrnaseq_umap_spotlight_problematic_celltypes.png")
