...
visium_subset <- readRDS("./output/processed_data/SCD-VI-i003/SCD-VI-i003_lognorm_seurat_predictions.rds")
...
for (i in rownames(visium_subset@assays$prediction.score.id@data)) {
  ...
  ggsave(paste("./output/images/SCD-VI-i003_integration/seurat_lognorm_prediction_", i, ".png", sep = ""))
}
...
ggsave("./output/images/SCD-VI-i003_integration/seurat_lognorm_prediction_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i003_integration/seurat_lognorm_prediction_spatial_scatterpie.pdf")
...
ggsave("./output/images/SCD-VI-i003_integration/seurat_lognorm_prediction_filtered_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i003_integration/seurat_lognorm_prediction_filtered_spatial_scatterpie.pdf")
...
ggsave("./output/images/SCD-VI-i003_integration/seurat_lognorm_comparison_celltype_proportions_scatter.png", width = 10, height = 6)
