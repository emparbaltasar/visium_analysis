...
# Load datasets
res <- readRDS("./output/processed_data/SCD-VI-i004/spotlight_lognorm.rds")
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_lognorm_topic_profiles.png")
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_lognorm_topic_profiles_facet.png", height = 20, width = 25)
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_lognorm_correlation_matrix.png")

plotInteractions(mat, "heatmap")
ggsave("./output/images/SCD-VI-i004_integration/spotlight_lognorm_interactions_heatmap.png")
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_lognorm_prediction_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i004_integration/spotlight_lognorm_prediction_spatial_scatterpie.pdf")
...
for (i in rownames(visium_subset@assays$predictions@data)) {
  ...
  ggsave(paste("./output/images/SCD-VI-i004_integration/spotlight_lognorm_prediction_", i, ".png", sep = ""))
}
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_lognorm_comparison_celltype_proportions_scatter.png", width = 10, height = 6)
