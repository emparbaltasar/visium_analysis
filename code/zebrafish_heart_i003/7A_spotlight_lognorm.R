...
# Load datasets
visium_subset <- readRDS("./output/processed_data/SCD-VI-i004/SCD-VI-i003_subset_lognorm_pca_clustered.rds")
scrnaseq <- readRDS("./output/processed_data/SCD-VI-i004/zebrafish_heart_scrnaseq_lognorm_pca.rds")
mgs <- read.csv("./output/processed_data/SCD-VI-i004/scrnaseq_lognorm_markers_auc.csv", row.names = 1)
...
saveRDS(res, file = "./output/processed_data/SCD-VI-i003/spotlight_lognorm_rawdata.rds")
