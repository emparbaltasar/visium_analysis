...
# Load datasets
res <- readRDS("./output/processed_data/SCD-VI-i004/spotlight_with_raw_data/spotlight_lognorm_rawdata.rds")
...
dir.create("./output/images/SCD-VI-i004_integration/spotlight_with_raw_data")
ggsave("./output/images/SCD-VI-i004_integration/spotlight_with_raw_data/spotlight_lognorm_topic_profiles.png")
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_with_raw_data/spotlight_lognorm_topic_profiles_facet.png", height = 20, width = 25)
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_with_raw_data/spotlight_lognorm_correlation_matrix.png")


plotInteractions(mat, "heatmap")
ggsave("./output/images/SCD-VI-i004_integration/spotlight_with_raw_data/spotlight_lognorm_interactions_heatmap.png", width = 10, height = 10)
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_prediction_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i004_integration/spotlight_prediction_spatial_scatterpie.pdf")
...
ggsave("./output/images/SCD-VI-i004_integration/spotlight_prediction_filtered_spatial_scatterpie.png")
ggsave("./output/images/SCD-VI-i004_integration/spotlight_prediction_filtered_spatial_scatterpie.pdf")
...
for (i in rownames(visium_subset@assays$predictions@data)) {
  ...
  ggsave(paste("./output/images/SCD-VI-i004_integration/spotlight_prediction_", i, ".png", sep = ""))
}
...
proportions_comparison %>%
  ...
  stat_cor(method = "pearson", label.x = 0.08, label.y = 0.75, size = 3) +
  stat_cor(method = "spearman", label.x = 0.08, label.y = 0.70, cor.coef.name = "rho", size = 3)

ggsave("./output/images/SCD-VI-i004_integration/spotlight_with_raw_data/spotlight_lognorm_comparison_celltype_proportions_scatter.png", width = 10, height = 6)
